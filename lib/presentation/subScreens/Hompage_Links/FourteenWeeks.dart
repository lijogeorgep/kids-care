...
class FourteenWeeks extends StatefulWidget {
  @override
  _FourteenWeeksState createState() => _FourteenWeeksState();
}

class _FourteenWeeksState extends State<FourteenWeeks> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.pink.shade400,
        title: Text('Vaccines after fourteen weeks'),
      ),
      body: SafeArea(
        child: Container(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Diptheria, Tetanus and Pertusis vaccine (DTP 3)',
